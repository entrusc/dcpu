 ...
 */
@InstructionDefinition(operation=Operation.MLI)
public class MLIInstruction extends Instruction {
        ...
        return new Command[] {
            ...
            new Command() {
                ...
                public void execute(DCPU dcpu) {
                    final Word overUnderFlow = operands[0].multiplySignedLocal(operands[1]);
